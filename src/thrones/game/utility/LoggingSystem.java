...
public class LoggingSystem {
    ...
    */
    static String canonical(GameOfThrones.Suit s) { return s.toString().substring(0, 1); }
    ...
    static String canonical(Hand h) {
        ...
        // the this::canonical method reference may cause issues, since this is no longer GameOfthrones
        // has been changed to a lambda function
    }
